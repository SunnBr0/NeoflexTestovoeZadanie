...
import "../../style/ItemBuyDevice.css";
function ItemBuyDevice() {
  return (
    <>
      <div className="itemBuyCart">
        <div className="itemBuyCartIconFuncButton">
          <img src="./assets/bigHeadPonse.png" alt="" />
        ...
        <div className="itemBuyCartInfo">
          <span className="itemBuyCartText">Apple Byz S852I</span>
          <span className="itemBuyCartPrice">2 927 ₽</span>
        </div>
